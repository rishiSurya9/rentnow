    ...
    <div className="min-h-screen bg-white text-gray-900 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[rgb(1,169,182)] mb-4">About Our Home Rental System</h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Description */}
          <div>
            <h2 className="text-3xl font-semibold mb-4 text-[rgb(1,169,182)]">What We Offer</h2>
        ...
        <section className="mt-16">
          <h2 className="text-3xl font-semibold mb-6 text-center text-[rgb(1,169,182)]">Key Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[rgb(1,169,182)] p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2 text-white">Scalable Architecture</h3>
              <p className="text-gray-700">
                Designed to handle heavy traffic and multiple users simultaneously, ensuring smooth performance.
              </p>
            </div>
            <div className="bg-[rgb(1,169,182)] p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2 text-white">Live Availability</h3>
              <p className="text-gray-700">
                View real-time property availability, complete with images, prices, and owner contact details.
              </p>
            </div>
            <div className="bg-[rgb(1,169,182)] p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2 text-white">Advanced Search Filters</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-[rgb(1,169,182)] p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2 text-white">Easy Property Listing</h3>
              <p className="text-gray-700">
                Property owners can easily list their homes with detailed descriptions, images, and contact information.
              </p>
            </div>
            <div className="bg-[rgb(1,169,182)] p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2 text-white">User-Friendly Design</h3>
              <p className="text-gray-700">
        ...
        <section className="mt-16 text-center">
          <h2 className="text-3xl font-semibold mb-4 text-[rgb(1,169,182)]">Our Vision</h2>
