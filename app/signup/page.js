  ...
  return (
    <div onSubmit={handleSubmit} className='p-3 max-w-lg mx-auto mt-8 bg-red-100  shadow-xl '>
      ...
      <form className='flex flex-col gap-4 p-4'>
        ...
        />
<<<<<<< HEAD
        <button  disabled={loading}onClick={notify} className=' bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg disabled:opacity-90'>
=======
...
>>>>>>> 3d8a5150a727f7ac2a24254358f88772bd757a6a
        {loading ? 'Loading...' : 'Sign Up'}
        </button>

       
  <button onClick={handleGoogleLogin} className='flex items-center gap-2 bg-white text-black hover:bg-gray-100 font-bold py-2 px-4 rounded-lg disabled:opacity-90 justify-center flex-1'>
