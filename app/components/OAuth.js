...
export const OAuth = () => {
    ...
    return (
        ...
        className='bg-red-500 text-white p-3 rounded-lg uppercase hover:opacity-95'>
         ...
         <button onClick={handleGoogleClick} className='flex items-center  gap-2 bg-white text-black hover:bg-gray-100 font-bold py-2 px-4 rounded-lg disabled:opacity-90  flex-1 mx-auto p-3 w-[450px] justify-center  border border-gray-300'>
